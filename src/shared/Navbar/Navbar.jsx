...
const NavBar = () => {
  ...
  return (
    <div className={color ? 'sticky  bg-[#174843] border-b border-[#40fe5c15] top-0 z-50 duration-300 shadow-md py-1' : 'pt-0 shadow-sm border-b border-[#40fe5c15] bg-[#174843] duration-300'}>
      <div className="max-w-[1540px] mx-auto xl:px-24 lg:px-16 md:px-10 sm:px-2 px-4">
