        ...
        <Container>
          ...
          <div className='flex justify-center items-center lg:gap-[70px]'>
            ...
            <div className='w-[52%]'>
              ...
              <img className='absolute 2xl:w-[30%] lg:w-auto 2xl:top-[-240px] 2xl:right-[570px]' src={aboutImgRightShadow} alt="image" />
              ...
              <div className='border-[3px] border-dashed lg:rounded-[30px] lg:pl-[50px]'>
                <div>
                  ...
                  <p className='lg:mt-[30px] 2xl:w-[94%] text-[#E5DADA] lg:text-[20px] lg:leading-[36px] lg:tracking-[0.8px]'>Visionary and inclusive, Snax Coin aims to reshape the future of finance, empowering users to navigate the digital landscape with confidence. Backed by a dynamic team of cryptocurrency veterans boasting expertise in blockchain technology, finance, and community development, Snax Coin stands poised to revolutionize the crypto space with integrity and purpose.</p>
