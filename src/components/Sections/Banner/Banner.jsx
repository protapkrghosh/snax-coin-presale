...
const Banner = () => {
  ...
  return (
    <div className="mt-[-80px]">
      <img src={bgImg} alt="Image" className="md:h-[500px] lg:h-[550px] xl:h-auto 2xl:h-[140vh] w-full hidden md:block" />
            ...
            <div className="w-[50%] flex justify-end">
              <div className="bg-[#] mt-[-70px] bgBlur">
                <div className="flex justify-end">
                  <img src={photoFrame} alt="Image" className="w-[580px] xl:h-[910px]" />
                </div>

                <div className="mt-[-850px] ml-[18px]">
