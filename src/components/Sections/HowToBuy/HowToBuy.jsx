...
import grass from '@/assets/howToBuy/Group 1171275261.png';
import shape from '@/assets/ourWayToTheMoon/Group 1171275272.png';
import vector1 from '@/assets/howToBuy/Vector.png';
import vector2 from '@/assets/howToBuy/Group.png';
import dog from '@/assets/howToBuy/logo_short_no_bg_square.png';
import dogBone from '@/assets/howToBuy/Group 1171275272.png';
import cardGrass from '@/assets/howToBuy/Group 1171275247.png';
import Container from '../Container/Container';

const HowToBuy = () => {
  return (
    <div className='mt-[138px] mb-[80px]'>
      <Container>
        {/* Buy heading */}
        <div className='flex justify-center mb-5 md:mb-10 lg:mb-0'>
          <div className='flex mt-5'>
            ...
            <h1 className='text-white text-[30px] md:text-[45px] lg:text-[60px] xl:text-[80px] text-center lg:leading-[88px] lg:tracking-[2.4px] mt-3 md:mt-5 lg:mt-5 xl:mt-10 ml-[-55px] md:ml-[-105px] lg:ml-[-140px] xl:ml-[-145px]'>How to <span className='bg-clip-text text-transparent bg-gradient-to-l from-[#F8B515] to-[#0FC1C7]'>buy?</span></h1>
          </div>
          <img src={grass} alt="Image" className='h-fit ml-4 md:ml-10 w-[35px] md:w-[45px] lg:w-[80px] xl:w-[170px]' />
        </div>
